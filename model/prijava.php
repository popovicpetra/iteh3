<?php 
    class Prijava {
        ...
        public static function update($id, $predmet, $katedra, $sala, $datum, mysqli $conn){
            $query_str = "UPDATE prijave SET predmet = '$predmet', katedra = '$katedra', sala = '$sala', datum = '$datum' WHERE id = $id";
            return $conn->query($query_str);
        }
